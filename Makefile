...
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer KeyChain PicoTts PrintSpooler Stk \
                     ...
                     webview CMSettingsProvider telresources shutdownlistener TimeService Snap
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport Pedometer MzCompaign Mall Wallet flymebbs EBook OperaMax
...
override_property += \
    ro.flyme.romer=olexandr1712 \
    ro.product.model_romer=LG-D724_Unofficial \
